...
import devolucionLeasing from '../img/icons/iconoDevolucion.png'
import { NavLink } from 'react-router-dom';

/**
 * Clase en donde estan las opciones de
 */
...
export default function Lista(){
    ...
    useEffect(() => {
        setpCread(JSON.parse(sessionStorage.getItem('cread')))
    }, [])
    return (
        <div>
            <List component='nav'>
                ...
                <ListItem button>
                    <ListItemIcon>
                        <div className={classes.div}>
                            <img className={classes.img} src={devolucionLeasing} />
                            <ListItemText className={classes.itemtext} primary='Devolución Leasing' />
                        </div>
                    </ListItemIcon>
                </ListItem>
                </NavLink>
                <NavLink to="/formGarantias"
                    style={{
                        color: "black",
                        textDecoration: "none"
                    }}
